...
var StaticDataSource = (function () {
    function StaticDataSource() {
        this.products = [
            ...
            new product_model_1.Product(3, "Product 3", "Category 1", "Product 3 (Category 2)", 100),
            new product_model_1.Product(4, "Product 4", "Category 1", "Product 4 (Category 2)", 100),
            new product_model_1.Product(5, "Product 5", "Category 1", "Product 5 (Category 2)", 100),
